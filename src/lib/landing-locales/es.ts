...
export const es: LandingDict = {
  ...
  scrolly: {
    ...
    s3h: "Descarga en Barcelona",
    s3p: "El conductor marca la descarga en la app y adjunta la foto del CMR. El gestor de tráfico lo ve en el mismo minuto.",
    ...
    cap3b: "Descarga confirmada.",
    cap3: " La foto del CMR llegada por Telegram queda adjunta al viaje.",
  ...
  roadmap: {
    ...
    lede: "No prometemos fechas. Mostramos el orden en que crece el producto y separamos con honestidad lo publicado de lo planificado.",
    now: "Ya funciona",
    wip: "En curso",
    next: "Después",
  },
  ...
  mock: {
    ...
    unloadTitle: "Viaje · descarga",
    unloadOk: "Descarga confirmada",
    unloadNote: "El conductor marcó la descarga en la app: el viaje se cerró solo.",
    unloadWhere: "Lugar",
    unloadPlace: "Barcelona · ES",
    unloadWhen: "Hora",
    unloadDocV: "CMR · foto",
    tgUnload: "Descargado en Barcelona, foto del CMR enviada.",
    tgTimeUnload: "hoy · 14:22",
