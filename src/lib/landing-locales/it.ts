...
export const it: LandingDict = {
  ...
  hero: {
    ...
    h1dim: "Sempre.",
    sub: " — il sistema di EU-compliance e pianificazione dei viaggi per vettori da 50 veicoli in su. Autisti, documenti, lavagna di disposizione e flotta — nel browser, senza hardware né consulenti d’implementazione. Operativo in un giorno.",
  ...
  pain: {
    ...
    fact2a: "Un autista con il Codice 95 scaduto — ",
  ...
  scrolly: {
    ...
    cap3b: "Il viaggio si è spostato da solo.",
    cap3: " Carta dell’autista nel nuovo mezzo — una voce nella cronologia.",
  ...
  vid: {
    ...
    sub: "A1, Code 95, visti — scadenze già sotto controllo oggi. Cabotaggio 3/7 — nella roadmap.",
  ...
  europe: {
    ...
    sub: "A1, Code 95, documenti dei conducenti — progettato secondo le regole UE. Ogni viaggio su una sola lavagna.",
  ...
  modules: {
    ...
    m8: "Telegram per i conducenti", m8d: "Documenti, turni e richieste",
  ...
  faq: {
    ...
    a1: "Ogni mattina G-Track controlla i documenti di tutta la flotta. Il passaporto alza la bandierina 180 giorni prima, tutti gli altri 90. L’avviso parte su tre canali insieme: una email in ufficio, un contrassegno dentro l’app e un push all’autista su Telegram.",
    a1b: "Quali avvisi ricevere e su quali canali lo decidi tu, per ogni tipo di notifica. Così il promemoria non resta appeso a una sola persona e non svanisce mentre l’HR è in ferie.",
  ...
  mock: {
    ...
    unloadTitle: "Viaggio · cambio mezzo",
    unloadOk: "Viaggio spostato dal sistema",
    unloadNote: "Carta dell’autista in un altro mezzo: chiuso il vecchio viaggio, aperto quello nuovo.",
    unloadWhere: "Nuovo mezzo",
    unloadPlace: "4TC 2190 · Barcellona",
    unloadWhen: "Ora",
    unloadDocV: "Carta tachigrafica",
