...
export const it: LandingDict = {
  ...
  scrolly: {
    ...
    s2p: "Il contachilometri arriva direttamente dal mezzo. G-Track calcola da solo quanto resta al tagliando e lo mette in piano — senza quaderni e telefonate all'officina.",
    s3h: "Scarico a Barcellona",
    s3p: "L'autista conferma lo scarico nell'app e allega la foto del CMR. Lo spedizioniere lo vede nello stesso minuto.",
    ...
    cap2b: "Chilometri al tagliando.",
    cap2: " Contachilometri dal mezzo, chilometri residui e un posto nel piano di manutenzione.",
    cap3b: "Scarico confermato.",
    cap3: " La foto del CMR arrivata da Telegram è allegata al viaggio.",
    cap4b: "Di nuovo in viaggio.",
    cap4: " Viaggio sulla lavagna, ogni modifica nella cronologia.",
    mapAria: "Mappa d'Europa: viaggio Praga → Monaco → Lione → Barcellona, il mezzo sulla tratta in corso",
    leg1: "Praga → Monaco",
    leg2: "Monaco → Lione",
    leg3: "Lione → Barcellona",
    arrived: "Arrivo · Barcellona",
  ...
  roadmap: {
    ...
    lede: "Non promettiamo date. Mostriamo l’ordine in cui il prodotto cresce, separando onestamente ciò che è rilasciato da ciò che è pianificato.",
    now: "Funziona oggi",
    wip: "In corso",
    next: "Prossimo",
  },
  ...
  mock: {
    ...
    svcOdo: "Contachilometri",
    svcNext: "Al tagliando",
    svcInterval: "Intervallo tagliando",
    svcCap: "dell'intervallo",
    svcSource: "dal mezzo",
    svcPlanned: "tagliando in piano",
    chipSvc: "Tagliando · 4 200 km",
    unloadTitle: "Viaggio · scarico",
    unloadOk: "Scarico confermato",
    unloadNote: "L'autista ha confermato lo scarico nell'app: il viaggio si è chiuso da solo.",
    unloadWhere: "Luogo",
    unloadPlace: "Barcellona · ES",
    unloadWhen: "Ora",
    unloadDocV: "CMR · foto",
    tgUnload: "Scaricato a Barcellona, foto del CMR inviata.",
    tgTimeUnload: "oggi · 14:22",
    sumOnTime: "viaggio in orario",
    sumKm: "km del viaggio",
    sumDocs: "documenti",
  },
};
