...
export const cs: LandingDict = {
  ...
  hero: {
    ...
    h1dim: "Vždy.",
    sub: " — systém EU compliance a plánování rejdů pro dopravce od 50 vozidel. Řidiči, dokumenty, dispečerská tabule a vozový park — v prohlížeči, bez hardwaru a bez implementačních konzultantů. Za den v provozu.",
