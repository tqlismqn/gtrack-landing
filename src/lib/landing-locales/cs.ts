...
export const cs: LandingDict = {
  ...
  scrolly: {
    ...
    s3h: "Vykládka v Barceloně",
    s3p: "Řidič potvrdí vykládku v aplikaci a přiloží foto CMR. Dispečer to vidí ve stejné minutě.",
    s4h: "Zase na cestě",
    ...
    cap3b: "Vykládka potvrzena.",
    cap3: " Foto CMR z Telegramu je přiloženo k jízdě.",
    cap4b: "Zase na cestě.",
  ...
  mock: {
    ...
    unloadTitle: "Jízda · vykládka",
    unloadOk: "Vykládka potvrzena",
    unloadNote: "Řidič potvrdil vykládku v aplikaci — jízda se uzavřela sama.",
    unloadWhere: "Místo",
    unloadPlace: "Barcelona · ES",
    unloadWhen: "Čas",
    unloadDocV: "CMR · foto",
    tgUnload: "Vyložil jsem v Barceloně, foto CMR posílám.",
    tgTimeUnload: "dnes · 14:22",
