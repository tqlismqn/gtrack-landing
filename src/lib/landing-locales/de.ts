...
export const de: LandingDict = {
  ...
  hero: {
    ...
    h1dim: "Immer.",
    sub: " — das EU-Compliance- und Tourenplanungssystem für Transportunternehmen ab 25 Lkw. Fahrer, Dokumente, Dispositionsboard und Flotte — im Browser, ohne Hardware und ohne Einführungsberater. Einsatzbereit an einem Tag.",
  ...
  scrolly: {
    ...
    s3h: "Entladung in Barcelona",
    s3p: "Der Fahrer bestätigt die Entladung in der App und hängt ein CMR-Foto an. Der Disponent sieht es in derselben Minute.",
    s4h: "Wieder auf Tour",
    ...
    cap3b: "Entladung bestätigt.",
    cap3: " Das CMR-Foto aus Telegram hängt an der Fahrt.",
  ...
  roadmap: {
    ...
    lede: "Wir versprechen keine Termine. Wir zeigen die Reihenfolge, in der das Produkt wächst — und trennen Ausgeliefertes klar von Geplantem.",
    now: "Läuft heute",
    wip: "In Arbeit",
    next: "Als Nächstes",
  },
  ...
  mock: {
    ...
    unloadTitle: "Fahrt · Entladung",
    unloadOk: "Entladung bestätigt",
    unloadNote: "Der Fahrer hat die Entladung in der App bestätigt — die Fahrt schloss sich selbst.",
    unloadWhere: "Ort",
    unloadPlace: "Barcelona · ES",
    unloadWhen: "Zeit",
    unloadDocV: "CMR · Foto",
    tgUnload: "In Barcelona entladen, CMR-Foto ist raus.",
    tgTimeUnload: "heute · 14:22",
