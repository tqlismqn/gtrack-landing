...
export const fr: LandingDict = {
  ...
  roadmap: {
    ...
    lede: "Nous ne promettons pas de dates. Nous montrons l’ordre dans lequel le produit grandit, en séparant honnêtement le livré du planifié.",
    now: "Déjà en place",
    wip: "En cours",
    next: "Ensuite",
  },
  ...
  mock: {
    ...
    svcOdo: "Compteur",
    svcNext: "Avant entretien",
    svcInterval: "Intervalle d'entretien",
    svcCap: "de l'intervalle",
    svcSource: "du camion",
