...
const ru = {
  ...
  scrolly: {
    ...
    s3h: "Выгрузка в Барселоне",
    s3p: "Водитель отмечает выгрузку в приложении и прикладывает фото CMR. Диспетчер видит факт в ту же минуту.",
    s4h: "Снова в рейс",
    ...
    cap3b: "Выгрузка отмечена.",
    cap3: " Фото CMR из Telegram прикреплено к рейсу.",
    cap4b: "Снова в рейс.",
  ...
  mock: {
    ...
    chipSvc: "ТО · 4 200 км",
    unloadTitle: "Рейс · выгрузка",
    unloadOk: "Выгрузка подтверждена",
    unloadNote: "Водитель отметил выгрузку в приложении — рейс закрылся сам.",
    unloadWhere: "Место",
    unloadPlace: "Барселона · ES",
    unloadWhen: "Время",
    unloadDocV: "CMR · фото",
    tgUnload: "Выгрузился в Барселоне, фото CMR отправил.",
    tgTimeUnload: "сегодня · 14:22",
...
const en: LandingDict = {
  ...
  scrolly: {
    ...
    s3h: "Unloading in Barcelona",
    s3p: "The driver marks the unload in the app and attaches a CMR photo. The dispatcher sees it the same minute.",
    ...
    cap3b: "Unload confirmed.",
    cap3: " The CMR photo from Telegram is attached to the trip.",
  ...
  mock: {
    ...
    unloadTitle: "Trip · unloading",
    unloadOk: "Unload confirmed",
    unloadNote: "The driver marked the unload in the app — the trip closed itself.",
    unloadWhere: "Place",
    unloadPlace: "Barcelona · ES",
    unloadWhen: "Time",
    unloadDocV: "CMR · photo",
    tgUnload: "Unloaded in Barcelona, CMR photo sent.",
    tgTimeUnload: "today · 14:22",
